...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user, repository, userCreated, userSaved, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, repository.save(userCreated)];
                    case 2:
                        userSaved = _a.sent();
                        return [2 /*return*/, response.json(userSaved)];
                    case 3:
                        error_1 = _a.sent();
    ...
    UserController.prototype.index = function (_request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, users, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    UserController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, repository, users, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
